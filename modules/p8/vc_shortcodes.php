...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p8' );
function wfnews_vc_shortcodes_p8() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 8", 'wfnews'),
      "base" => "wfnews_post_block_8_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_8.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 8', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
		 ...
		 array(
            "type" => "textfield",            
            "class" => "",
            "heading" => esc_html__("Posts Title Limit In Character (Optional)", "wfnews" ).''.$wfnewsabout.'',
