...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p9' );
function wfnews_vc_shortcodes_p9() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 9", 'wfnews'),
      "base" => "wfnews_post_block_9_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_9.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 9', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
