...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p10' );
function wfnews_vc_shortcodes_p10() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 10", 'wfnews'),
      "base" => "wfnews_post_block_10_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_10.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 10', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
		...
		array(            
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Read More Button Color", "wfnews" ),
            "param_name" => "r_more_btn_color",
            "value" => '', 
            "description" => ""
         ),	
		 array(
