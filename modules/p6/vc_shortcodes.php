...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p6' );
function wfnews_vc_shortcodes_p6() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 6", 'wfnews'),
      "base" => "wfnews_post_block_6_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_6.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 6', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
		 ...
		 array(
            "type" => "checkbox",            
            "class" => "",
            "heading" => esc_html__("Do you want Tab options? [PRO FEATURES]", 'wfnews'),
		 ...
		 array(
            "type" => "checkbox",            
            "class" => "",
            "heading" => esc_html__("Choose Category For Top Tabs", 'wfnews'),
            "param_name" => "toptabcategory",
            "value" => wfnews_post_categories_ID(),
			'dependency' => array(
				 'element' => 'taboption',
				 'value' =>'yes',
			 ),
            "description" => esc_html__( "You must choose at least 1 category from here to make the tab options work", "wfnews" )
         ),
		 array(
            "type" => "checkbox",            
            "class" => "",
            "heading" => esc_html__("Choose Category For Tab Dropdown", 'wfnews'),
            ...
            "description" => esc_html__( "You must choose at least 2 category from here to make the tab options work", "wfnews" )
         ),
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Choose Background For Tab Dropdown", "wfnews" ),
            ...
            "description" => esc_html__( "Choose Background For Tab Dropdown", "wfnews" )
         ),
		array(            
			"type" => "textfield",                        
			"class" => "",            
		...
		array(            
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Block Post Title color", "wfnews" ).''.$wfnewsabout.'',
            "param_name" => "blockposttitlecolor",
            "value" => '', //Default Red color
            "description" => esc_html__( "Choose Block Post Title color", "wfnews" )
         ),
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Block Date & Meta color", "wfnews" ),
		 ...
		 array(
            "type" => "checkbox",            
            "class" => "",
            "heading" => esc_html__("On/Off post date meta", 'wfnews'),
            "param_name" => "post_date_meta",
			"std"		=> "yes",
            "value" => array(
				//Label => Value
				"Yes" => "yes"
		...
		array(            
			"type" => "textfield",                        
			"class" => "",            
			"heading" => esc_html__("Title Font Size", 'wfnews'),            
		...
		array(            
			"type" => "textfield",                        
			"class" => "",            
			"heading" => esc_html__("Title Line Height", 'wfnews'),            
		...
		array(            
			...
			"param_name" => "next_button_font_size",            
			"description" => esc_html__("Insert font size (e.g 22px)", 'wfnews'),
			'group' => 'Button-Settings', 			
		),
		 array(
		...
		array(            
			"type" => "textfield",                        
			"class" => "",            
			"heading" => esc_html__("Tab Line Height", 'wfnews'),            
