...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p4' );
function wfnews_vc_shortcodes_p4() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 4", 'wfnews'),
      "base" => "wfnews_post_block_4_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_4.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 4', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
		...
		array(            
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Button Background Color", "wfnews" ),
