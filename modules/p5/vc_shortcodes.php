...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p5' );
function wfnews_vc_shortcodes_p5() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 5", 'wfnews'),
      "base" => "wfnews_post_block_5_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_5.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 5', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
		 ...
		 array(
            "type" => "textfield",            
            "class" => "",
            "heading" => esc_html__("Small Posts Title Limit In Word (Optional)", "wfnews" ).''.$wfnewsabout.'',
		 ...
		 array(
            "type" => "textfield",            
            "class" => "",
            "heading" => esc_html__("Small Posts Excerpt Limit In Word (Optional)", 'wfnews'),
            "param_name" => "sm_post_excerpt_limit",
            "value" => 20,
			"std" => 20,
            "description" => 'Please enter Number for limit your post title (Optional)'
         ),		 
		...
		array(            
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Large Post Title Color", "wfnews" ),
