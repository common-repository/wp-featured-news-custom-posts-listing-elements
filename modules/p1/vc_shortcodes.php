...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p1' );
function wfnews_vc_shortcodes_p1() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 1", 'wfnews'),
      "base" => "wfnews_post_block_1_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_1.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 1', 'wfnews'),
      "params" => array(
		 array(
            "type" => "textfield",
            "class" => "",
		 ...
		 array(
            "type" => "checkbox",
            "class" => "",
            "heading" => esc_html__("Do you want Next - Prev button?", "wfnews" ).''.$wfnewsabout.'',
		 ...
		 array(
            "type" => "checkbox",
            "class" => "",
            "heading" => esc_html__("Do you want Tab options?", "wfnews" ).''.$wfnewsabout.'',
		 ...
		 array(
            "type" => "checkbox",
            "class" => "",
            "heading" => esc_html__("Choose Category For Top Tab", 'wfnews'),
		 ...
		 array(
            ...
            "description" => esc_html__("Choose minimum 2 categories to display dropdown.", 'wfnews')
         ),
		 array(
            "type" => "colorpicker",
            "class" => "",
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Block Active Tab color", "wfnews" ),
            "param_name" => "block_tab_active_color",
            "value" => '', //Default Red color
            "description" => esc_html__( "Choose Block color", "wfnews" )
         ),
		  array(
