...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p3' );
function wfnews_vc_shortcodes_p3() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 3", 'wfnews'),
      "base" => "wfnews_post_block_3_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_3.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 3', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
