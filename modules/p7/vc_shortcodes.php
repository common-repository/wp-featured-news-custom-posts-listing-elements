...
/*-----------------------------------------------------------------------------------*/
add_action( 'init', 'wfnews_vc_shortcodes_p7' );
function wfnews_vc_shortcodes_p7() {
...
vc_map( array(
      "name" => esc_html__("FThemes - Post Block 7", 'wfnews'),
      "base" => "wfnews_post_block_7_post",
      "icon" => WFNEWS_IMAGE_DIR .'block_7.png',
      "class" => "",
      "category" => esc_html__('by Fluent-Themes Shortcodes', 'wfnews'),
      'admin_enqueue_js' => '',
      'admin_enqueue_css' => '',
      'description' => esc_html__('Post Block 7', 'wfnews'),
      "params" => array(         
		 array(
            "type" => "textfield",            
            "class" => "",
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Block Category Background Color", "wfnews" ),
            "param_name" => "blockcategorybackground",
            "value" => '', //Default Red color
            "description" => esc_html__( "Choose Block Category Background Color", "wfnews" )
         ),		 
		 array(
            "type" => "textfield",            
            "class" => "",
		 ...
		 array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Block color", "wfnews" ),
		...
		array(            
		 ...
		 array(
            "type" => "checkbox",            
            "class" => "",
            "heading" => esc_html__("On/Off  post cat meta", 'wfnews'),
            "param_name" => "post_cat_meta",
			"std"		=> "yes",
            "value" => array(
				//Label => Value
				"Yes" => "yes"
